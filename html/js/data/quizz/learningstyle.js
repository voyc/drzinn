voyc.data.quizz['learningstyle'] = {
	...
	calcScores: function() {
		...
		voyc.drzinn.scores.set(testname, 'auditory'   , scores[1], Math.round((scores[0]/total)*100));
		voyc.drzinn.scores.set(testname, 'kinesthetic', scores[2], Math.round((scores[0]/total)*100));
	}
}
