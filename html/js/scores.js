...
voyc.data.examples = {
	...
	'motivation': {
		'definitions'         : { pct:[  2,  8,  5], answers:[ 3, 4,19,39,82,110] },                  //  6
		'feelings'            : { pct:[  4,  2,  8], answers:[ 8,46,47,58,59,83,84] },                //  7
		'efficiency'          : { pct:[  7,  4,  2], answers:[15,16,17,30,35,54,55,56,57,116] },      // 10
		'curiosity'           : { pct:[  2,  7,  4], answers:[18,36,37,38,67,68,118] },               //  7
		'authority'           : { pct:[  6,  2,  7], answers:[1,2,7,77,78,79,81,107,108,109] },       // 10
		'resistance'          : { pct:[  7,  6,  2], answers:[9,20,44,45,48,49,85,86,87,102] },       // 10
		'wariness'            : { pct:[  3,  7,  6], answers:[21,22,23,24,50,80,90,91,98,119] },      // 10
		'tools'               : { pct:[  5,  3,  7], answers:[5,6,103,104,105] },                     //  5
		'affection'           : { pct:[  9,  5,  3], answers:[26,27,28,29,42,63,112,113,114,115] },   // 10
		'acclaim'             : { pct:[  1,  9,  5], answers:[60,62,99,100,101,106,111,120,121] },    //  9
		'pressure'            : { pct:[  6,  1,  9], answers:[13,14,25,64,70,92,93,94,95] },          //  9
		'direct'              : { pct:[ 10,  6,  1], answers:[43,65,66,96,97,117] },                  //  6
		'avoidance'           : { pct:[  0, 10,  6], answers:[10,11,12,31,32,33,34,72,73,74] },       // 10
		'disappointment'      : { pct:[  5,  0, 10], answers:[40,41,51,52,53,71,75,76,88,89] },       // 10
	},
	'personality': {
